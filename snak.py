...
pygame.display.set_caption("THE SNACKE GAME")
...
font = pygame.font.SysFont("poppins", 45)
...
def snake():
    ...
    pygame.draw.rect(game_screen, (0, 204, 0), [x, y, 10, 10])
...
while True:
    if (game_over):
       game_screen.fill((0, 0, 0))
       score = font.render("SCORE: " + str(len(body_list)), True, (204, 255, 255))
       game_screen.blit(score, [0, 0])
